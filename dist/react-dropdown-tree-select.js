            ...
            (r = [
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    h = s.readOnly,
                    y = s.clientId,
                    b = { className: 'node-label' }
                  'simpleSelect' === t && !h && !p && (b.onClick = this.handleCheckboxChange)
                  var g = { id: o, value: f, checked: c, disabled: p, readOnly: h, tabIndex: -1 },
                  ...
                  return i().createElement(
                    ...
                    'radioSelect' === t
                      ? i().createElement(
                          Qe,
                          et({ name: y, className: 'radio-item', onChange: this.handleCheckboxChange }, g)
                        )
                      : i().createElement(
                          Ye,
                          et({ name: o, className: v, indeterminate: d && a, onChange: this.handleCheckboxChange }, g)
                        ),
                    i().createElement('span', b, l ? '<img src="' + l + '" alt=""/>' : '', n),
                    i().createElement('span', { className: 'node-label-email' }, u)
                  )
                },
              },
            ]),
