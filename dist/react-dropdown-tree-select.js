    ...
    return (
      (() => {
        ...
        ;(K = H),
          ...
          U in K
            ? Object.defineProperty(K, U, { value: q, enumerable: !0, configurable: !0, writable: !0 })
            : (K[U] = q)
        const W = H
        function z(e) {
          return (
        ...
        var Ue = ['name', 'checked', 'onChange', 'disabled', 'readOnly']
        function qe() {
          return (
            (qe =
              Object.assign ||
              ...
              (r = [
                {
                  ...
                  value: function() {
                    ...
                    return i().createElement(
                      'input',
                      qe({ type: 'radio', name: t, ref: Ze({ checked: r }), onChange: n, disabled: l }, c)
                    )
                  },
                },
              ]) && We(t.prototype, r),
            ...
            (r = [
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    a = e.partial,
                    c = e.checked,
                    l = (e.imageUrl, e.email),
                    u = this.props,
                    s = u.value,
                    f = u.disabled,
                    p = u.showPartiallySelected,
                    d = u.readOnly,
                    h = u.clientId,
                    y = { className: 'node-label' }
                  'simpleSelect' === t && !d && !f && (y.onClick = this.handleCheckboxChange)
                  var b = { id: o, value: s, checked: c, disabled: f, readOnly: d, tabIndex: -1 },
                    g = ['checkbox-item', 'simpleSelect' === t && 'simple-select'].filter(Boolean).join(' '),
                    v = function(e) {
                      return e ? i().createElement('img', { src: e, alt: '' }) : null
                    }
                  return i().createElement(
                    'label',
                    { title: r || n, htmlFor: o },
                    'radioSelect' === t
                      ? i().createElement(
                          Qe,
                          et({ name: h, className: 'radio-item', onChange: this.handleCheckboxChange }, b)
                        )
                      : i().createElement(
                          Ye,
                          et({ name: o, className: g, indeterminate: p && a, onChange: this.handleCheckboxChange }, b)
                        ),
                    i().createElement('span', y, v, n),
                    i().createElement('span', { className: 'node-label-email' }, l)
                  )
                },
              },
            ]),
              ...
              (r = [
                {
                  ...
                  value: function() {
                    var e = this.props,
                      ...
                      _ = r || !O ? { paddingLeft: ''.concat(20 * (l || 0), 'px') } : {},
                      E = ''.concat(n, '_li')
                    return i().createElement(
                      'li',
                      wt({ className: T, style: _, id: E }, c(a), this.getAriaAttributes()),
                      i().createElement(mt, { isLeaf: Ct(o), expanded: u, id: n, onNodeToggle: w }),
                      i().createElement(ut, {
                        title: s,
                        label: f,
                        email: p,
                      ...
                      i().createElement(xe, { actions: v, onAction: m, id: n, readOnly: j })
                    )
                  },
                },
              ]),
        ...
        const Ht = function(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'children',
            r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : qt
          return (
            Ut()(e[t], function(e) {
              return r(e).checked
            }) ||
